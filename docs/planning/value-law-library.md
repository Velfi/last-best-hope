...
> **Planning status — 2026-07-24:** this is an authored-content specification,
> not a catalogue of content currently available in a campaign. The shared
> precedent implementation exists; each proposed value chain still requires
> explicit integration and validation before it can be described as playable.
