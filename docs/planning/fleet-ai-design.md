...
> **Planning status — 2026-07-24:** the stealth/maneuver layer, command stances,
> and deterministic trainer are present. The command hierarchy, group doctrine,
> capability allocation, and delivery sequence below are proposed follow-on work
> rather than a description of the whole current combat AI.
