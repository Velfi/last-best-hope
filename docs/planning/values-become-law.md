...
> **Planning status — 2026-07-24:** the repository already contains persisted
> precedent records, precedent-case resolution, the shared application query,
> save validation, tests, and a campaign view. This document remains a planning
> contract because its complete player-flow integration, validation gates, and
> the broader authored library are not established as current-game guarantees.
