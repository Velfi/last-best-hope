...
The [Membrane FTL](membrane-ftl.md) contract governs how a fleet reaches a
surveyed system and why its measurements, routes, and communication cannot be
treated as instantaneous. Dark-native organisms and their route effects are
specified separately in [Dark ecology](dark-ecology.md).
...
- [Membrane FTL](membrane-ftl.md) defines the interstellar transit and
  correspondence rules connecting generated systems.
- [Dark ecology](dark-ecology.md) defines native life encountered along those
  routes; it does not change this system generator's physical survey model.
